"""
This file is used for transformation
from MIINST official data to .jpg
...
TRAIN_IMAGES_DIR = "/Users/jp/Desktop/2020-CS172/dataset/train_imgaes"
TEST_IMAGES_DIR = "/Users/jp/Desktop/2020-CS172/dataset/test_imgaes"
...
def convert_to_image(dataset_type):
    ...
    for i in range(image_num):
        ...
        image_path = images_dir + str(label) + "/" + str(label) + "_" + str(counter[label]) + ".jpg"
